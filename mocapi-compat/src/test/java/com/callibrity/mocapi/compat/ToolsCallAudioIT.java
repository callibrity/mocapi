...
class ToolsCallAudioIT {
  ...
  void callAudioReturnsAudioContent() throws Exception {
    ...
    var params = new CallToolRequestParams("test_audio_content", arguments, null, null);
    ...
    assertThat(content.get("type").asString()).isEqualTo("audio");
    assertThat(content.get("data").asString())
        .isEqualTo("UklGRiUAAABXQVZFZm10IBAAAAABAAEARKwAAESsAAABAAgAZGF0YQEAAACA");
    assertThat(content.get("mimeType").asString()).isEqualTo("audio/wav");
  }
}
