...
import com.callibrity.mocapi.protocol.tools.McpToolProvider;
...
import com.callibrity.mocapi.protocol.tools.schema.MethodSchemaGenerator;
...
@PropertySource("classpath:mocapi-protocol-tools-defaults.properties")
@RequiredArgsConstructor
public class MocapiProtocolToolsAutoConfiguration {

  private final MocapiProtocolToolsProperties props;
  private final MocapiProtocolProperties mocapiProperties;
