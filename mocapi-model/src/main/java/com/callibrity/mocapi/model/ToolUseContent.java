...
/**
 * A request from the assistant to call a tool during sampling. The {@code id} matches a subsequent
...
public record ToolUseContent(
    String id, String name, ObjectNode input, @JsonProperty("_meta") ObjectNode meta)
