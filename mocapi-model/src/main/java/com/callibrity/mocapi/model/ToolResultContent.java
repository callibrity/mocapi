...
/**
 * The result of a tool use, provided by the user back to the assistant during sampling. {@code
 * toolUseId} must match a previous {@link ToolUseContent#id()}; {@code structuredContent} may be
 * any JSON value.
 *
...
public record ToolResultContent(
    ...
    implements SamplingMessageContentBlock {}
