...
/**
 * Emits floating-point progress notifications for one operation (ADR-0025). Created from {@link
 * McpProgressSource#doubleProgress(Double)}, which captures the total once; each call reports the
 * absolute progress value so far.
 *
