...
> For the design rationale (why Substrate, why pluggable from day one,
> multi-node correctness) see
> [`../design/storage-and-substrate.md`](../design/storage-and-substrate.md)
> and [ADR-0007](../adr/0007-substrate-storage-spi.md).
...
For how each SPI is used end-to-end (session lookup, the Mailbox
rendezvous for elicitation/sampling, SSE journal replay), see
[`../design/storage-and-substrate.md`](../design/storage-and-substrate.md).
