...
Each registered prompt (and any enum-typed argument's completion candidates) is logged at `INFO` level during startup. See [Startup Logging](../design/architecture-overview.md#startup-logging) for the full catalog.
