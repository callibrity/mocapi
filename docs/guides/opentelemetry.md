...
For production, 0.01–0.10 is typical. Our standing [performance baseline](performance/benchmarking.md) measures 100% sampling — production throughput is typically 5–10% higher at 0.05 sampling, not a regression.
