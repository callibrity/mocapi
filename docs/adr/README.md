...
- [ADR-0034 — Descriptor `_meta` and descriptor-customizer seams](0034-descriptor-meta-and-customizer-seams.md) *(Amended by ADR-0039)*
...
- [ADR-0037 — `mocapi-tasks`: the MCP Tasks extension and its execution model](0037-mcp-tasks-extension.md) *(Amended by ADR-0040)*
