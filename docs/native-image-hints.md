...
- `mocapi.api.*` annotations + SPI ifaces — 8 (`@ToolService`, `@ToolMethod`, `@PromptService`, `@PromptMethod`, `McpPromptProvider`, `McpResourceProvider`, `McpResourceTemplateProvider`, `PromptTemplateFactory`)
