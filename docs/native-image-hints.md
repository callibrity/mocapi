...
- `mocapi.api.*` annotations + SPI ifaces — 9 (`@ToolService`, `@ToolMethod`, `@PromptService`, `@PromptMethod`, `McpToolProvider`, `McpPromptProvider`, `McpResourceProvider`, `McpResourceTemplateProvider`, `PromptTemplateFactory`)
